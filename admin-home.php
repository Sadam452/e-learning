    ...
    <div class="container py-4" id="admin-home">
        <div class="row d-lg-flex justify-content-evenly align-items-lg-center mb-0">
            <div
				...
				<button class="btn btn-light" id="btn" onclick="window.location.href='tutorReport.php' ">Generate Tutor Report</button><br>
				<button class="btn btn-light" id="btn" onclick="window.location.href='verify.php' ">Verify Users</button><br>
			...
			<div class="card mt-5 rounded-3" style="box-shadow: 0px 0px 20px 8px var(--bs-gray-800);background: rgb(255,251,251);">
                    <div class="card-body d-flex flex-column align-items-center py-5">
                        ...
                        <h2 class="mb-5"><b>Admin Home</b></h2>
                        <span>It is easy to manage your students and tutors with us. Just follow the following steps:
                        <ul>
                        	<li>Create an account</li>
                        	<li>Login</li>
                        	<li>And avail lot of benefits</li>
                        </ul>
						
						<div class="mb-3"><button class="btn btn-success d-block w-100 mt-2" onclick="window.location.href='verify.php' ">Verify users</button>
						</div>
					</div>
			</div>
            </div>
