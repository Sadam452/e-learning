        ...
        <div class="row d-lg-flex justify-content-evenly align-items-lg-center mb-0">
            ...
            <div class="col-md-6 col-xl-7" id="admin-home-right"> 
            	<form action="viewResults.php" method="post">
                        ...
                        <button class="btn btn-primary mt-2" type="submit" name="button" value="upload">Get Result</button>&nbsp; OR
                        <!-- <button class="btn btn-success" type="submit" name="button" vaule="getAll">Get Result</button> -->
                </form> 
                <form action="viewResults.php" method="post">
                	<button class="btn btn-success mt-2" type="submit" name="button" value="all">Get All Quiz Details</button>
                </form>
            	<?php
				  if($_SERVER['REQUEST_METHOD'] == 'POST'){
				    ...
				    if($_POST['button'] == "upload"){
				    	$subject=$_POST['subject'];
				  		$q="SELECT * FROM quiz_users WHERE subject='$subject' "; }
				    if($_POST['button'] == "all")
				  	$q="SELECT * FROM quiz_users ";
					$status=mysqli_query($con,$q);
