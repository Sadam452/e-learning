        ...
        <div class="row d-lg-flex justify-content-evenly align-items-lg-center mb-0">
			...
			<div class="mt-5 rounded-3">
                    <div class="card-body d-flex flex-column align-items-center py-5">
                        ...
                        <h2 class="mb-5"><b>Upload a Resource</b></h2>
                        <form action="uploadResources.php" method="post">
                        <table class="table table-hover">
	            		<tr>
			  				<td>#sNo</td>
			  				<td>Subject</td>
			  				<td>Topic</td>
			  				<td>Video/Material URL</td>
			  				<td>Remarks</td>
			  			</tr>
            			<tr>
			  				<td>1</td>
						...
						<div class="mb-3"><button class="btn btn-success d-block w-100 mt-2" type="submit" name="button" value="upload">Upload</button>
						</div>
						</form>
					</div>
			</div>
...
<?php
  ...
  $q="INSERT INTO resources (subject,topic,url,remarks) VALUES ('$subject','$topic','$url','$remarks') ";
