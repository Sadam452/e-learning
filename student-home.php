        ...
        <div class="row d-lg-flex justify-content-evenly align-items-lg-center mb-0">
			...
			<div class="card mt-5 rounded-3" style="box-shadow: 0px 0px 20px 8px var(--bs-gray-800);background: rgb(255,251,251);">
                    <div class="card-body d-flex flex-column align-items-center py-5">
                        ...
                        <h2 class="mb-5"><b>Take a Quiz</b></h2>
						<span> Now it is easy to check your knowledge by following these simple steps:</span>
							<ol>
								<li>Register with us</li>
								<li>Login</li>
								<li>Check resources option to prepare</li>
								<li>Take a quiz</li>
								<li>View quiz results</li>
							</ol>
						<div class="mb-3"><button class="btn btn-success d-block w-100 mt-2" type="submit" name="button" onclick="window.location.href='quiz.php';" value="start">Start Quiz</button>
						</div>
					</div>
			</div>
            </div>
